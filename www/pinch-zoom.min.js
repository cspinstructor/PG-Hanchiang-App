    ...
    t.prototype = {
      ...
      handleZoom: function(t, i) {
        ...
        (this.lastScale = i),
          (this.nthZoom += 1),
          this.nthZoom > 3 &&
            (this.scale(n, e), this.drag(e, this.lastZoomCenter)),
      ...
      sanitizeOffset: function(t) {
        var i =
          ...
          o = e - this.getContainerY() + this.options.verticalPadding,
          s = Math.max(n, 0),
          a = Math.max(o, 0),
          h = Math.min(n, 0) - this.options.horizontalPadding,
          r = Math.min(o, 0) - this.options.verticalPadding;
        return {
          x: Math.min(Math.max(t.x, h), s),
          y: Math.min(Math.max(t.y, r), a)
        };
      },
      ...
      canDrag: function() {
        return (
          ...
          !((t = this.zoomFactor) > (i = 1) - 0.01 && t < i + 0.01)
        );
        var t, i;
      },
      drag: function(t, i) {
      ...
      getCurrentZoomCenter: function() {
        ...
        return { x: i, y: -1 * this.offset.y - e / (1 / this.zoomFactor - 1) };
      },
    ...
    var e = function(t, i) {
      ...
      t.addEventListener('touchstart', function(t) {
        i.enabled &&
          ...
          (function(t) {
            ...
            if ((n > 1 && (o = null), s - o < 300))
              switch ((l(t), i.handleDoubleTap(t), e)) {
                case 'zoom':
                  i.handleZoomEnd(t);
                  break;
                case 'drag':
        ...
        t.addEventListener('touchend', function(t) {
          i.enabled && ((n = t.touches.length), h(t));
        });
    };
    return t;
  },
